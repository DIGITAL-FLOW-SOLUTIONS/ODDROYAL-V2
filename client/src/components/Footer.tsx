...
export default function Footer() {
  ...
  return (
    <footer className="bg-sidebar border-t border-sidebar-border mt-auto w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
      <div className="max-w-none px-0 py-8">

...
import { Shield, Clock, AlertTriangle, Phone } from "lucide-react";
    ...
    <div className="w-full px-8 py-12">
      ...
      >
        <div className="space-y-2">
          <h1 className="text-3xl font-display font-bold text-foreground">Responsible Gaming</h1>
        ...
        <div className="max-w-none text-foreground space-y-6">
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0 text-foreground">Our Commitment to Responsible Gaming</h2>
              </div>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Our Responsible Gaming Standards</h3>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">Understanding Problem Gambling</h2>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">What is Problem Gambling?</h3>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Types of Gambling Problems</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Common Myths and Facts</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="border border-destructive/20 rounded-lg p-4 bg-destructive/5">
                  <h4 className="font-medium text-destructive mb-2">Myth</h4>
                  <p className="text-sm text-destructive/80">"Problem gamblers lack willpower or self-control"</p>
                </div>
                <div className="border border-chart-4/20 rounded-lg p-4 bg-chart-4/5">
                  <h4 className="font-medium text-chart-4 mb-2">Fact</h4>
                  <p className="text-sm text-chart-4/80">Problem gambling is a mental health condition that affects brain chemistry and decision-making</p>
                </div>
                <div className="border border-destructive/20 rounded-lg p-4 bg-destructive/5">
                  <h4 className="font-medium text-destructive mb-2">Myth</h4>
                  <p className="text-sm text-destructive/80">"You can predict gambling outcomes with systems or strategies"</p>
                </div>
                <div className="border border-chart-4/20 rounded-lg p-4 bg-chart-4/5">
                  <h4 className="font-medium text-chart-4 mb-2">Fact</h4>
                  <p className="text-sm text-chart-4/80">All gambling outcomes are random and independent of previous results</p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0 text-foreground">Warning Signs and Risk Factors</h2>
              </div>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Behavioral Warning Signs</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Emotional Warning Signs</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Financial Warning Signs</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Risk Factors for Problem Gambling</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0 text-foreground">Self-Control Tools and Player Protection</h2>
              </div>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Spending Controls</h3>
              
              <h4 className="text-base font-medium text-foreground">Deposit Limits</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h4 className="text-base font-medium text-foreground">Loss Limits</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h4 className="text-base font-medium text-foreground">Bet Size Limits</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Time Management Tools</h3>

              <h4 className="text-base font-medium text-foreground">Session Time Limits</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h4 className="text-base font-medium text-foreground">Reality Checks</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Account Controls</h3>

              <h4 className="text-base font-medium text-foreground">Self-Exclusion</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h4 className="text-base font-medium text-foreground">Take a Break</h4>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Advanced Protection Features</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">Responsible Gaming Guidelines and Best Practices</h2>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Financial Guidelines</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Time Management Guidelines</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Emotional Guidelines</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Decision-Making Guidelines</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0 text-foreground">Professional Support and Treatment Resources</h2>
              </div>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">National Support Organizations</h3>
              ...
              <h3 className="text-lg font-medium text-foreground">Specialized Treatment Options</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">International Resources</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">Supporting Family and Friends</h2>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Signs Your Loved One May Have a Gambling Problem</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">How to Help</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Family Support Resources</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">Youth and Underage Gambling Prevention</h2>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Our Youth Protection Measures</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Warning Signs in Young People</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Education and Prevention</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Youth Support Resources</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">Research, Education, and Industry Initiatives</h2>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Research and Development</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Industry Partnerships</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">Educational Initiatives</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">Getting Help and Support</h2>
              <p>
              ...
              <h3 className="text-lg font-medium text-foreground">Immediate Support Options</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">How to Access Help</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium text-foreground">What to Expect When Seeking Help</h3>
              <ul className="list-disc pl-6 space-y-2">

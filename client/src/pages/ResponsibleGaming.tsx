      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-display font-bold">Responsible Gaming</h1>
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0">Warning Signs</h2>
              </div>
              <p>
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0">Self-Control Tools</h2>
              </div>
              <p>
              ...
              <h3 className="text-lg font-medium">Loss Limits</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-medium">Session Time Limits</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold">Responsible Gaming Guidelines</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold m-0">External Support Resources</h2>
              </div>
              <p>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-6">
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-lg mb-2">GamCare</h3>
                  <p className="text-sm text-muted-foreground mb-3">Free confidential support and advice</p>
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-lg mb-2">Gamblers Anonymous</h3>
                  <p className="text-sm text-muted-foreground mb-3">Peer support meetings and resources</p>
                  <ul className="space-y-1 text-sm">
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-lg mb-2">GamStop</h3>
                  <p className="text-sm text-muted-foreground mb-3">Self-exclusion across all UK gambling sites</p>
                  <ul className="space-y-1 text-sm">
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-lg mb-2">BeGambleAware</h3>
                  <p className="text-sm text-muted-foreground mb-3">Information and support resources</p>
                  <ul className="space-y-1 text-sm">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold">Underage Gaming Prevention</h2>
              <p>

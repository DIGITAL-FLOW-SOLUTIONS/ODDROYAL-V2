...
function MpesaDeposit() {
  ...
  const [amount] = useState(
    urlParams.get("amount") || localStorage.getItem("mpesa_amount") || "2000",
  );
  const [currency] = useState(
    urlParams.get("currency") ||
      localStorage.getItem("mpesa_currency") ||
      "KES",
  );
      ...
      try {
        ...
        if (data.success) {
          if (data.data.status === "completed") {
            ...
            toast({
              ...
              description:
                data.data.message ||
                "Payment was not completed. You may have cancelled or entered wrong PIN.",
              variant: "destructive",
            });
            return;
          }
        ...
        if (attempts < maxAttempts) {
          ...
          toast({
            ...
            description:
              "Payment verification timed out. Please check your M-PESA messages or try again.",
            variant: "destructive",
          });
        }
      } catch (error) {
        ...
        if (attempts < maxAttempts) {
          ...
          toast({
            ...
            description:
              "Unable to verify payment. Please check your M-PESA messages.",
            variant: "destructive",
          });
        }
      }
  ...
  const handleSubmit = () => {
    ...
    const newDepositId = (
      100000 +
      ((Date.now() + Math.floor(Math.random() * 1000)) % 900000)
    ).toString();
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto p-4 md:p-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6 order-2 lg:order-1 flex flex-col">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div
                        ...
                        data-testid="row-deposit-amount"
                      >
            ...
            >
              ...
              >
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-2xl">Total Due</CardTitle>
                  <p
                          ...
                          {configLoading ? (
                            ...
                            <div className="text-center py-4">
                              ...
                              <p className="text-xs text-destructive">
                                Unable to load paybill number. Please try again.
                              </p>
                            </div>
                          ) : (
                            <div className="space-y-2">
                              <div>
                                ...
                                <p
                                  ...
                                  data-testid="text-manual-paybill"
                                >
                                  {paybillNumber}
                                </p>
                              </div>
                              <div>
                                ...
                                <p
                                  className="font-mono font-bold text-primary text-lg"
                                  data-testid="text-manual-account"
                                >
                                  {depositId}
                                </p>
                              </div>
                              <div>
                                ...
                                <p
                                  className="font-mono font-bold text-primary text-lg"
                                  data-testid="text-manual-amount"
                                >
                                  {parseInt(amount).toLocaleString()} KES
                                </p>
                              </div>
                            </div>
                          )}
                  ...
                  {transactionId && (
                    <div className="text-center text-xs text-muted-foreground border-t pt-3">
                      ...
                      <p
                        ...
                        data-testid="text-transaction-id"
                      >

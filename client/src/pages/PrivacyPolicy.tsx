      ...
      <div className="w-full px-8 py-12">
        ...
        >
          ...
          <div className="prose prose-gray max-w-none text-gray-900">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-900">4. Data Security and Protection</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-900">5. Cookies and Tracking Technologies</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-900">9. Policy Updates</h2>
              <p>
